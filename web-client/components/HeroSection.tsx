...
export default function HeroSection() {
  ...
  // High-fidelity text colors configured exclusively for the light theme
  const words = [
    { text: "Earn", color: "text-emerald-600" },
    { text: "Post", color: "text-amber-500" },
    { text: "Scale", color: "text-[#007FFF]" }
  ];
  ...
  return (
    <section 
      ...
      className="relative w-full bg-white pt-20 pb-28 md:pt-24 md:pb-36 overflow-hidden transition-colors duration-300 select-none"
    >
      ...
      <div className="mx-auto max-w-[76rem] px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center text-center">
        ...
        <div className="mb-6 inline-flex items-center gap-2 px-4 py-1.5 rounded-lg bg-slate-50 border border-slate-200/80 text-xs font-medium text-[#838991] tracking-wide">
        ...
        <div className="relative max-w-4xl px-4">
          ...
          <div className="absolute -top-6 left-2 text-emerald-500 opacity-90 pointer-events-none animate-pulse">
          ...
          <div className="absolute -top-10 left-[43%] text-amber-500 opacity-80 pointer-events-none">
          ...
          <div className="absolute top-1/2 -right-8 text-[#007FFF] opacity-80 pointer-events-none hidden md:block">
          ...
          <h1 className="text-[2.6rem] sm:text-[3.6rem] lg:text-[4rem] font-black tracking-tight text-slate-900 leading-[1.12]">
        ...
        <p className="max-w-2xl mt-6 text-base sm:text-lg font-medium text-[#989a9c] leading-relaxed antialiased">
        ...
        <div className="w-full max-w-[62rem] relative px-4 md:px-0">
          <div className="relative h-[340px] sm:h-[400px] md:h-[440px] w-full flex items-center justify-center">
            ...
            <div className="absolute left-0 lg:left-[4%] top-[10%] w-[35%] sm:w-[31%] h-[80%] rounded-2xl bg-white shadow-[0_20px_50px_-12px_rgba(0,0,0,0.12)] border border-slate-100 transform -rotate-6 hover:rotate-0 hover:scale-[1.03] transition-all duration-500 ease-out z-10 overflow-hidden flex flex-col group">
              <div className="h-[50%] w-full bg-slate-100 relative">
                <img 
                  src="/assets/move.jpg" 
              ...
              <div className="h-[50%] w-full p-4 flex flex-col justify-between text-left">
                <div>
                  <h4 className="text-slate-900 font-extrabold text-xs sm:text-sm tracking-tight leading-tight">UniWork Verified</h4>
                  <p className="text-slate-400 text-[9px] sm:text-xs font-semibold mt-0.5">Student Earner Deck</p>
                </div>
                <div className="flex items-center justify-between border-t border-slate-50 pt-3 text-[9px] font-bold text-slate-400 tracking-wider uppercase">
                  <span>ID 2026</span>
            ...
            <div className="absolute top-0 w-[36%] sm:w-[30%] h-[92%] rounded-2xl bg-white shadow-[0_30px_70px_-15px_rgba(0,0,0,0.22)] md:shadow-[0_45px_85px_-20px_rgba(0,0,0,0.6)] border border-slate-200/60 transform rotate-2 hover:rotate-0 hover:scale-[1.04] transition-all duration-500 ease-out z-30 overflow-hidden flex flex-col group">
              <div className="h-[45%] w-full bg-amber-500/10 relative">
                <img 
                  src="/assets/wall.jpg" 
              ...
              <div className="h-[55%] w-full p-4 sm:p-5 flex flex-col justify-between text-left">
                <div>
                  <h4 className="text-slate-900 font-black text-sm sm:text-base tracking-tight leading-tight">UniWork Verified</h4>
                  <p className="text-slate-400 text-[10px] sm:text-xs font-bold mt-0.5">Micro-Gig Network</p>
                </div>
                <div className="flex items-center justify-between border-t border-slate-100/60 pt-3 text-[9px] font-bold text-slate-400 tracking-wider uppercase">
                  <span>ID 0032</span>
                  <span className="text-emerald-500">Active</span>
                </div>
              </div>
            ...
            <div className="absolute right-0 lg:right-[4%] top-[14%] w-[35%] sm:w-[31%] h-[76%] rounded-2xl bg-white shadow-[0_20px_50px_-12px_rgba(0,0,0,0.12)] border border-slate-100/80 transform rotate-6 hover:rotate-0 hover:scale-[1.03] transition-all duration-500 ease-out z-20 overflow-hidden flex flex-col group">
              <div className="h-[50%] w-full bg-slate-100 relative">
                <img 
                  src="/assets/COP.jpg" 
              ...
              <div className="h-[50%] w-full p-4 flex flex-col justify-between text-left">
                <div>
                  <h4 className="text-slate-900 font-extrabold text-xs sm:text-sm tracking-tight leading-tight">UniWork Verified</h4>
                  <p className="text-slate-400 text-[9px] sm:text-xs font-semibold mt-0.5">Corporate Client Pool</p>
                </div>
                <div className="flex items-center justify-between border-t border-slate-50 pt-3 text-[9px] font-bold text-slate-400 tracking-wider uppercase">
                  <span>ID 7099</span>
                  <span className="text-[#007FFF]">Enterprise</span>
                </div>
              </div>
            </div>
          ...
          <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 w-64 h-2 opacity-10 pointer-events-none">
            <svg className="w-full h-full text-slate-900" viewBox="0 0 300 10" fill="none" preserveAspectRatio="none">
